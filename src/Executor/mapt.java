 ...
 * @date 2020/9/21
 **/
public class mapt implements test {
    ...
    public void executeTestCase(String program_name, String version, int repeatTimes) {
        ...
        for (int i = 0; i < constant.repeatnum; i++) {
            System.out.println(program_name + " " + version + " use MAPT ; now testing " + String.valueOf(i + 1));

            // initialize MAPT
            MAPT mapt = new MAPT();
            mapt.initializeMAPT(constant.get_num_of_partition(program_name));
...
//            }
        ...
        String txtLogName = "MAPT_" + program_name + "_" + version + ".txt";
        ...
        String txtSpecificName = "MAPT_" + program_name + "_" + version + "_Content.txt";
